    ...
    >
      <CarouselContent className="-ml-6 items-center">
        {images.map((src, index) => (
          ...
          >
            <div className="flex items-center justify-center lg:opacity-55 lg:grayscale lg:filter lg:transition lg:duration-300 lg:hover:opacity-100 lg:hover:grayscale-0">
              <AppImage
                src={src}
                alt={`Banner ${index + 1}`}
                width={120}
