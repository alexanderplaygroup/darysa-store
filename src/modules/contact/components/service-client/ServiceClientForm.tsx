...
const formSchema = z.object({
  ...
  purchaseDocument: z.string().nonempty('El documento de compra es obligatorio'), // nuevo campo
...
export function ServiceClientForm() {
  ...
  return (
    <div className="space-y-7">
      <Heading as="h1" variant="subheading">
        Servicio al <span className="font-black">Cliente</span>
      </Heading>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-darysa-gris-700 font-semibold">
                    Documento con el que se realizó la compra{' '}
